export const data = [
	{
		...
		properties: [
			...
			{ propertyClass: 'bg-amber-500', propertyText: 'Cute but not domestic' },
			{ propertyClass: 'bg-rose-500', propertyText: 'Sometimes strange' },
		],
		description: [
	...
	},
	{
		...
		properties: [
			{ propertyClass: 'bg-emerald-500', propertyText: 'You need this animal in forests' },
			{ propertyClass: 'bg-amber-500', propertyText: 'Beware of close contact' },
			{ propertyClass: 'bg-rose-500', propertyText: 'Dont be rush' },
		],
		description: [
	...
	},
	{
		...
		properties: [
			{ propertyClass: 'bg-emerald-500', propertyText: 'Super fast' },
			{ propertyClass: 'bg-rose-300', propertyText: 'Silent' },
			{ propertyClass: 'bg-rose-500', propertyText: 'You should never running away' },
		],
		description: [
